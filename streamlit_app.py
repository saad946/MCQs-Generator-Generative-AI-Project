...
with open('C:\\Users\\Dell\\Desktop\\Python\\Generative AI\\MCQs-Generator-Generative-AI-Project\\Response.json', 'r') as file:
    RESPONSE_JSON = json.load(file)


# # Loading JSON file using a relative path
